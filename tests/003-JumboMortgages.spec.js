...
test("verify Jumbo Mortgages page", async({page})=>{
    ...
    //await expect(page.locator("(//h2[normalize-space()='Table of Contents'])[1]")).toHaveText("Table of Contents");
    ...
    // await expect(page.locator("//div[text()=' President']")).toHaveText(" President");
